    ...
    <div class="container mx-auto w-full text-gray-700 ">
        <div x-data="{ open: false }"
            ...
            <nav :class="{ 'flex': open, 'hidden': !open }"
                ...
                <a href="{{ route('order') }}"
                    class="relative block font-semibold p-2  lg:p-10 bg-primary-two text-white lg:h-full {{ request()->routeIs('order') ? ' bg-primary-four text-white' : '' }}"><span
                        class="lg:absolute lg:left-[22%] lg:top-[37%]">Order</span></a>
