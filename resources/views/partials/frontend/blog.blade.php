...
<section class="px-4 md:px-16 lg:px-24 py-14">
    <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-4">
        ...
        <div class="bg-gray-100">
            ...
            <h2 class="bg-white text-2xl w-full text-center md:text-left mt-4 sm:mt-0"><a href="{{ route('blog.show',$blogs[0]->slug) }}">{{ $blogs[0]->title }}</a></h2>
        ...
        <div class="bg-gray-100">
            ...
            <p class="bg-white py-4 mx-auto md:mx-0">Published by <i class="fa fa-user px-1"></i> admin on <i class="fa fa-clock-o px-1"></i> July 28, 2021</p>
            <h2 class="bg-white text-2xl w-full text-center md:text-left mt-4 sm:mt-0"><a href="{{ route('blog.show',$blogs[1]->slug) }}">{{ $blogs[1]->title }}</a></h2>
            <p class="bg-white leading-normal py-4 text-center md:text-left">
                Writing a term paper deserving of a good score takes far more than a few hours of hard work and several sentences on-page. Time, organization, and […]
            </p>    
        ...
        <div class="bg-gray-100">
            ...
            <p class="bg-white py-4 mx-auto md:mx-0">Published by <i class="fa fa-user px-1"></i> admin on <i class="fa fa-clock-o px-1"></i> July 28, 2021</p>
            <h2 class="bg-white text-2xl w-full text-center md:text-left mt-4 sm:mt-0"><a href="{{ route('blog.show',$blogs[2]->slug) }}">{{ $blogs[2]->title }}</a></h2>
            <p class="bg-white leading-normal py-4 text-center md:text-left">
                Writing a term paper deserving of a good score takes far more than a few hours of hard work and several sentences on-page. Time, organization, and […]
            </p>    
        ...
        <div class="bg-gray-100">
            ...
            <p class="bg-white py-4 mx-auto md:mx-0">Published by <i class="fa fa-user px-1"></i> admin on <i class="fa fa-clock-o px-1"></i> July 28, 2021</p>
            <h2 class="bg-white text-2xl w-full text-center md:text-left mt-4 sm:mt-0"><a href="{{ route('blog.show',$blogs[3]->slug) }}">{{ $blogs[3]->title }}</a></h2>
            <p class="bg-white leading-normal py-4 text-center md:text-left">
                Writing a term paper deserving of a good score takes far more than a few hours of hard work and several sentences on-page. Time, organization, and […]
            </p>    
        ...
        <div class="bg-gray-100">
            ...
            <p class="bg-white py-4 mx-auto md:mx-0">Published by <i class="fa fa-user px-1"></i> admin on <i class="fa fa-clock-o px-1"></i> July 28, 2021</p>
            <h2 class="bg-white text-2xl w-full text-center md:text-left mt-4 sm:mt-0"><a href="{{ route('blog.show',$blogs[4]->slug) }}">{{ $blogs[4]->title }}</a></h2>
            <p class="bg-white leading-normal py-4 text-center md:text-left">
                Writing a term paper deserving of a good score takes far more than a few hours of hard work and several sentences on-page. Time, organization, and […]
            </p>    
        ...
        <div class="bg-gray-100">
            ...
            <p class="bg-white py-4 mx-auto md:mx-0">Published by <i class="fa fa-user px-1"></i> admin on <i class="fa fa-clock-o px-1"></i> July 28, 2021</p>
            <h2 class="bg-white text-2xl w-full text-center md:text-left mt-4 sm:mt-0"><a href="{{ route('blog.show',$blogs[5]->slug) }}">{{ $blogs[5]->title }}</a></h2>
            <p class="bg-white leading-normal py-4 text-center md:text-left">
                Writing a term paper deserving of a good score takes far more than a few hours of hard work and several sentences on-page. Time, organization, and […]
            </p>    
        ...
        <div class="bg-gray-100">
            ...
            <p class="bg-white py-4 mx-auto md:mx-0">Published by <i class="fa fa-user px-1"></i> admin on <i class="fa fa-clock-o px-1"></i> July 28, 2021</p>
            <h2 class="bg-white text-2xl w-full text-center md:text-left mt-4 sm:mt-0"><a href="{{ route('blog.show',$blogs[6]->slug) }}">{{ $blogs[6]->title }}</a></h2>
            <p class="bg-white leading-normal py-4 text-center md:text-left">
                Writing a term paper deserving of a good score takes far more than a few hours of hard work and several sentences on-page. Time, organization, and […]
            </p>    
        ...
        <div class="bg-gray-100">
            ...
            <p class="bg-white py-4 mx-auto md:mx-0">Published by <i class="fa fa-user px-1"></i> admin on <i class="fa fa-clock-o px-1"></i> July 28, 2021</p>
            <h2 class="bg-white text-2xl w-full text-center md:text-left mt-4 sm:mt-0"><a href="{{ route('blog.show',$blogs[7]->slug) }}">{{ $blogs[7]->title }}</a></h2>
            <p class="bg-white leading-normal py-4 text-center md:text-left">
                Writing a term paper deserving of a good score takes far more than a few hours of hard work and several sentences on-page. Time, organization, and […]
            </p>    
