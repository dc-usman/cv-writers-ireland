...
@section('content')
    ...
    <main class="">
        <section class="container mx-auto px-3 md:px-14 my-6 md:min-h-[15rem]">
            <p class="my-2">
                Perfectresume.ae is UAE’s leading resume writing & editing service providers. We have helped many candidates in achieving their goals and catching the most suitable opportunities. We work in detail and provide CV writing service that professionally represent you in front of an employer.
            </p>
            <p class="my-2">
